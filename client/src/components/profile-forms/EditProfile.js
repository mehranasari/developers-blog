...
const EditProfile = ({ createProfile, history, getCurrentProfile, profile: { profile, loading } }) => {
  ...
  const { company, image, website, location, status, skills, githubusername, bio, twitter, facebook, youtube, linkedin, instagram } = formData;
  ...
  return (
    <Fragment>
      ...
      <img class="round-img" src={loading || profile.image === null ? (<Spinner />) : profile.image} alt="" />
